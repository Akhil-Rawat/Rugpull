  ...
  return (
    <nav className="fixed top-0 w-full bg-gray-100 z-50 border-b-4 border-green-900">
      <div className="max-w-7xl mx-auto px-6 py-3 flex items-center justify-between gap-6">
        ...
        >
          <div>
            <h2 className="font-bold text-base text-green-900 font-mono tracking-wider">
              SHIELDFI
            </h2>
            ...
            {tabs
              ...
              .map((tab) => (
                <motion.button
                  ...
                  className={
                    "px-4 py-2 font-mono text-sm font-bold whitespace-nowrap border-3 transition-all uppercase tracking-wider bg-green-900 text-white border-green-900"
                  }
